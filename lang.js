...
const translations = {
    ru: {
        ...
        submit: "Отправить",
        allRights: "Все права защищены PlayRolls и PlaySet",
        copyright: "© 2025 PlayRolls и PlaySet. Все права защищены.",
        ...
        indexP4: "Компания PlayRolls и PlaySet не несет ответственности за использование материалов сайта третьими лицами без разрешения. Мы оставляем за собой право предпринимать юридические действия в случае нарушения наших прав.",
        indexH3_4: "Согласие",
        ...
        termsP2: "Форум PlayFun и все его материалы принадлежат компании PlayRolls и её партнеру PlaySet. Все права на контент, включая текст, изображения, графику, логотипы, программное обеспечение и другие элементы, защищены законами об авторском праве.",
    ...
    en: {
        ...
        submit: "Submit",
        allRights: "All rights reserved PlayRolls and PlaySet",
        copyright: "© 2025 PlayRolls and PlaySet. All rights reserved.",
